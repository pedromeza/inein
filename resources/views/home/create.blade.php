    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                <form method="post" action="{{ route('listar.store') }}">
                    @csrf
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="number" onkeypress="return valideKey(event);" class="form-control" name="monto"/>
                        </div>
                        <div class="form-group col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="2" columns="5" class="form-control" name="descripcion"></textarea>
                    </div>
